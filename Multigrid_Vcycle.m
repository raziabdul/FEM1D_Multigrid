...
% Multigrid V-cycle
% This is a recursive function. It starts with the top level of the grid,
% then exits at the bottom after performing the direct solution.
%
...
% pos_steps : Number of iterations in the post-smoothing
	...
	% Pre-smoothing
	x = smoother(A, b, 1e-14, pre_steps, x0); % calls gauss-seidel by default
